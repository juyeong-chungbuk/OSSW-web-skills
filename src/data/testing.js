			...
			skills: [
				{
					...
					description: {
						text: "Learn about various software testing methodologies and why it is important to test your code.",
						links: [
					...
					skills: [
						{
							name: "Unit Testing",
							description: {
								text: "Learn about unit testing and how it can be used to test individual units of code.",
								links: [
						...
						},
						{
							...
							description: {
								text: "Learn about integration testing and how it can be used to test modules as a group.",
								links: [
						...
						},
						{
							name: "System Testing",
							description: {
								text: "Learn about system testing and how it can be used to test the fully integrated software product.",
								links: [
						...
						},
						{
							name: "Smoke Testing",
							description: {
								text: "Learn about smoke testing and how it can be used to ensure that critical functionalities of the program are working fine.",
								links: [
						...
						},
						{
							...
							description: {
								text: "Learn about performance testing and how it can be used to determine the responsiveness and stability of a program.",
								links: [
						...
						},
						{
							...
							description: {
								text: "Learn about usability testing and how it can be used to determine if the system is easily usable for the end-user.",
								links: [
						...
						},
						{
							...
							description: {
								text: "Learn about white box testing and how it can be used to test the software's internal structure, design, and coding.",
								links: [
						...
						},
						{
							...
							description: {
								text: "Learn about black box testing and how a test can be carried out without looking at the internal code.",
								links: [
						...
						},
						{
							name: "Manual Testing",
							description: {
								text: "Learn about manual testing and when it should be applied.",
								links: [
				...
				},
				{
					name: "A/B Testing",
					description: {
						text: "Learn about A/B testing and how it can be used to optimize your web app.",
						links: [
				...
				},
				{
					name: "Test Runners",
					description: {
						text: "Learn about test runners and how they can help running tests.",
						links: [
					...
					skills: [
						...
						},
						{
							name: "Mocha",
							description: {
								text: "Learn about the Mocha testing framework.",
								links: [
						...
						},
						{
							name: "Jasmine",
							description: {
								text: "Learn about the Jasmine testing frameworks.",
								links: [
						...
						},
						{
							name: "Cypress",
							description: {
								text: "Learn how to use Cypress for end-to-end-testing.",
								links: [
				...
				},
				{
					name: "Best Practices",
					description: {
						text: "Learn about the best practices when it comes to testing.",
						links: [
